/* Reservation Form Logic — v2.1b: fixed date 2025-10-24 */
const qs = (s, el=document) => el.querySelector(s);
const qsa = (s, el=document) => Array.from(el.querySelectorAll(s));

const STATE_KEY = "booking_state_v2_1b";
const ADMIN_PARAM = new URL(location.href).searchParams.get("admin") === "1";

let state = { data: {}, version: 212 };
...
function loadState() {
  try {
    ...
    if (parsed && parsed.version === 212) state = parsed;
